"""中国新闻出版研究院 www.chinapublish.com.cn"""
...
LIST_URLS = [
    "http://www.chinapublish.com.cn/ywdt/",     # 业务动态
    "http://www.chinapublish.com.cn/xwzx/",     # 新闻中心
]


class ChinapublishCrawler(BaseCrawler):
    name = "中国新闻出版研究院"
    base_url = "http://www.chinapublish.com.cn"
            ...
            for li in items:
                try:
                    ...
                    if not pub_date:
                        ...
                        if detail:
                            m2 = re.search(r'(\d{4}-\d{2}-\d{2})', detail[:3000])
                            if m2:
                                pub_date = m2.group(1)
                    ...
                    if detail:
                        ...
                        content = dsoup.select_one(".TRS_Editor, .article_content, #zoom, .content")
                        if content:
